...
with col2:
    ...
    st.markdown("<p class='small-font'>Don't have an account? Go <a href='http://localhost:8501/Sign_Up'>Sign Up</a> and reserve your tickets!</p></h2>", unsafe_allow_html=True)
